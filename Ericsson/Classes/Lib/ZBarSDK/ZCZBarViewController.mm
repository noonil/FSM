...
#define LineX (KIphoneWidth-220)/2
#define LineY 70
#define LineW 220
#define LineH 2
...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        UIImage*image= [UIImage imageNamed:@"qrcode_scan_bg_Green.png"];
          bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64, KIphoneWidth, self.view.frame.size.height-64-100)];
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 300, KIphoneWidth, 40)];
    ...
    //扫描线
    _line = [[UIImageView alloc] initWithFrame:CGRectMake(LineX, LineY, LineW, LineH)];
    _line.image = [UIImage imageNamed:@"qrcode_scan_light_green.png"];
    [bgImageView addSubview:_line];
   
    
    //存放下方按钮
    UIImageView *scanImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, bgImageView.frame.size.height+64, KIphoneWidth, 100)];
    ...
    NSArray*unSelectImageNames=@[@"qrcode_scan_btn_flash_nor.png"];
    NSArray*selectImageNames=@[@"qrcode_scan_btn_flash_down.png"];
    ...
    for (int i=0; i<unSelectImageNames.count; i++) {
        ...
        button.frame=CGRectMake(KIphoneWidth/2-50, 0, 100, 100);
    ...
    //假导航
    UIImageView *navImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, KIphoneWidth, 64)];
    navImageView.image=[UIImage imageNamed:@"qrcode_scan_bar.png"];
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.bounds.size.width / 2 - 30, 16 , 64, 44)];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
         ...
         _line.frame = CGRectMake(LineX, LineY+220, LineW, LineH);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:2 animations:^{
          _line.frame = CGRectMake(LineX, 70, LineW, LineH);
        }];
