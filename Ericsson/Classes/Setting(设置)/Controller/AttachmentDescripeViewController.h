...
@protocol AttachmentDescripeDelegate <NSObject>
- (void)submitContentText:(NSString*)text;
@end


@interface AttachmentDescripeViewController : BaseViewController

@property (nonatomic, strong) NSData *infoData;
@property (nonatomic, strong) NSString *infoFileName;
@property (nonatomic, strong) NSString *fileType;
@property (weak ,nonatomic) id<AttachmentDescripeDelegate> delegate;
