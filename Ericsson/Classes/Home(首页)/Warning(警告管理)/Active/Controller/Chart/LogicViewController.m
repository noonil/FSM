...
- (void)viewDidLoad {
    ...
    NSMutableArray *arr1=[NSMutableArray arrayWithObjects:@"0",@"200",@"400",@"600",@"800",@"1000", nil];
    NSMutableArray *arr2=[NSMutableArray arrayWithObjects:@"103",@"150",@"330",@"0",@"200",@"280",@"700",@"350",@"300",@"800",@"140",@"350",@"70",@"220",@"0",@"0",@"170",@"186",@"0", nil];
    //竖轴
    NSUInteger i = 0;
    for (; i<19; i++) {
        CGFloat height = 18;
    ...
    for(int i=0;i<arr2.count;i++){
        ...
        if ([UIScreen mainScreen].bounds.size.width<=320)
        {
            ...
            view.frame=CGRectMake(60,40+i*height1 ,0.3*[[arr2 objectAtIndex:i]floatValue], 16);
            label2.frame=CGRectMake(60+0.3*[[arr2 objectAtIndex:i]floatValue], 40+i*height1,50 , 16);
        ...
        if ([UIScreen mainScreen].bounds.size.width>320)
        {
            ...
            view.frame=CGRectMake(70,40+i*height1 ,0.35*[[arr2 objectAtIndex:i]floatValue], 16);
            label2.frame=CGRectMake(70+0.35*[[arr2 objectAtIndex:i]floatValue], 40+i*height1,50 , 16);
            [view setBackgroundColor:[UIColor colorWithRed:0/255.0 green:122/255.0 blue:255/255.0 alpha:1]];
            [self.view addSubview:view];
            [self.view addSubview:label2];
        }
