...
//    CGSize departNameSize   = [departName sizeWithFont:AnnounceOthersFont];
    CGFloat departNameW     = cellW - nameSize.width;
//    CGSize departNameSize = [contentModel.departName sizeWithFont:AnnounceOthersFont maxW:departNameW];
    CGFloat departNameH     = nameSize.height;
    self.departNameLabelF   = (CGRect){{departNameX,departNameY},{departNameW,departNameH}};
//    self.departNameLabelF   = (CGRect){{departNameX,departNameY},departNameSize};
    
    // 时间label
    CGSize timeSize = [contentModel.time sizeWithFont:AnnounceOthersFont];
    CGFloat timeX = 0;
    CGFloat timeY = nameSize.height + nameY;;
