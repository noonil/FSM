...
@interface OMLViewController ()

@end

@implementation OMLViewController
...
- (void)viewDidLoad {
    ...
    NSMutableArray *arr2=[NSMutableArray arrayWithObjects:@"13",@"15",@"33",@"27",@"20",@"21",@"35",@"35",@"30",@"51",@"14",@"21",@"7",@"22",@"2",@"3",@"17",@"16",@"50", nil];
    //竖轴
    NSUInteger i = 0;
    for (; i<19; i++) {
        CGFloat height = 18;
    ...
    for(int i=0;i<arr2.count;i++){
        ...
        if ([UIScreen mainScreen].bounds.size.width<=320)
        {
            ...
            view.frame=CGRectMake(60,40+i*height1 ,3*[[arr2 objectAtIndex:i]floatValue], 16);
            label2.frame=CGRectMake(60+3*[[arr2 objectAtIndex:i]floatValue], 40+i*height1,50 , 16);
        ...
        if ([UIScreen mainScreen].bounds.size.width>320)
        {
            ...
            view.frame=CGRectMake(70,40+i*height1 ,3.5*[[arr2 objectAtIndex:i]floatValue], 16);
            label2.frame=CGRectMake(70+3.5*[[arr2 objectAtIndex:i]floatValue], 40+i*height1,50 , 16);
            [view setBackgroundColor:[UIColor colorWithRed:0/255.0 green:122/255.0 blue:255/255.0 alpha:1]];
            [self.view addSubview:view];
            [self.view addSubview:label2];
        }
