...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    GotoWebCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = (GotoWebCell *)[[[NSBundle mainBundle] loadNibNamed:@"GotoWebCell" owner:nil options:nil] lastObject];
    }
